...
(function (global, factory) {
  ...
  Promise.prototype.then = function (onfulfilled, onrejected) {
    ...
    */
    ...
    onfulfilled = typeof onfulfilled === 'function' ? onfulfilled : (value) => { return value };// .then两个参数初始化为函数
    onrejected = typeof onrejected === 'function' ? onrejected : (reason) => {throw reason};    // 抛错误是因为：不写第二个函数，使用.then.catch会导致直接走.then第二个省略的参数，返回成功的状态
